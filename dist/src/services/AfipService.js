...
exports.getAfipService = getAfipService;
...
class AfipService {
    ...
    async ensureAfip() {
        ...
        if (!cfg)
            throw new Error('Falta configurar AFIP');
...
let instance = null;
function getAfipService() { if (!instance)
    instance = new AfipService(); return instance; }
