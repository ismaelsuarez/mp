...
class IdempotencyManager {
     ...
     */
    async markAsApproved(ptoVta, tipoCbte, nroComprobante, cae, caeVto) {
        try {
     ...
     */
    async markAsFailed(ptoVta, tipoCbte, nroComprobante, errorMsg) {
        try {
