...
class AfipHelpers {
     ...
     */
    static mapCbteByClass(kind, clase) {
        if (kind === 'FACT') {
    ...
    static buildQrUrl(data) {
        const qrData = {
            ver: 1,
            fecha: (0, dayjs_1.default)(data.fecha, 'YYYYMMDD').format('YYYY-MM-DD'),
            cuit: data.cuit,
            ptoVta: data.ptoVta,
     ...
     */
    static validateComprobante(comprobante) {
        const errors = [];
...
exports.AfipHelpers = AfipHelpers;
