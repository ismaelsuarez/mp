...
exports.ATMService = void 0;
exports.createATMService = createATMService;
...
class ATMService {
    constructor(mockMode = true) {
        this.nombre = 'ATM Mendoza';
        this.jurisdiccion = 'mendoza';
     ...
     */
    async validarComprobante(params) {
     ...
     */
    async registrarComprobante(params) {
     ...
     */
    async consultarEstado(numeroComprobante) {
     ...
     */
    verificarJurisdiccionMock(cuitEmisor, cuitReceptor) {
 ...
 */
function createATMService(mockMode = true) {
