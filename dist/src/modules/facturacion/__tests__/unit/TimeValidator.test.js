...
describe('TimeValidator', () => {
    let timeValidator;
    beforeEach(() => {
        timeValidator = new TimeValidator_1.TimeValidator();
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    describe('validateSystemTime', () => {
        ...
        it('debería usar configuración personalizada', async () => {
            ...
            const validator = new TimeValidator_1.TimeValidator(customConfig);
    ...
    describe('configuración', () => {
        it('debería usar configuración por defecto', () => {
            const validator = new TimeValidator_1.TimeValidator();
