...
/**
 * Obtiene la clave de cifrado para electron-store
 */
...
/**
 * Obtiene el store de configuración cifrado
 */
...
/**
 * Construye un cliente de MercadoPago
 */
...
/**
 * Convierte rango de fechas local a UTC para la API de MP
 */
...
/**
 * Busca pagos en MercadoPago usando la configuración de electron-store
 * Migrado desde src/services/MercadoPagoService.ts
 * 
...
/**
 * Prueba la conexión a MercadoPago con el token configurado
 */
