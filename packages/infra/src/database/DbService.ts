...
/**
 * Servicio de base de datos usando better-sqlite3
 * Migrado desde src/services/DbService.ts
 * 
 * @infra/database - Wrapper para persistencia SQLite
 */
class DbService {
	private dbPath: string; // Path a la base de datos SQLite
	private db: any | null = null; // Instancia de better-sqlite3
	private enabled: boolean = false; // Flag para saber si SQLite está disponible
	private fallbackPath: string; // Path al archivo JSON de fallback
